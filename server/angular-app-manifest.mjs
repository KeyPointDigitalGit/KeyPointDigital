...
export default {
  ...
  assets: {
    ...
    'clienti/index.html': {size: 33381, hash: '6bf34b5e27c4eed99fa45872ac8344cfc7a2f2361c638a535728ae4fe3c0de3e', text: () => import('./assets-chunks/clienti_index_html.mjs').then(m => m.default)},
